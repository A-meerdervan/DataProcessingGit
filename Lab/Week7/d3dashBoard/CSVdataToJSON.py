...
INPUT_CSV_POP = "sp.pop.totl_Indicator_en_csv_v2"
        ...
        for row in reader:
            ...
            if i > 4:
                ...
                if countryCode in EUROPE_CODES:
                    ...
                    FILTERED_DATA_ROWS[i - 5].append(population2013)
                    i+= 1
                    for row in FILTERED_DATA_ROWS:
                        print row

def main():
	# Here are the country codes to translate between two letter and 3 letter codes
	country_codes = [
    ["af", "AFG", "Afghanistan"],
	...
	# These were taken from a previous assignment
	europeCodes2Letters = ["fr", "it", "at", "se", "pt", "de", "dk", "lv", "ro", "cz", "fi", "gb", "ie", "pl", "be", "bg", "ee", "es", "hu", "nl", "sk", "lt", "gr", "si", "cy", "lu", "mt"]
	# these are filled by comparing the above with country_codes rows
	europeCodes3Letters = []
    for country in country_codes:
      if country[0] in europeCodes2Letters:
         europeCodes3Letters.append(country[1])
         if __name__ == '__main__':
            print europeCodes3Letters
    # main()
